# Generated by Django 3.1.7 on 2021-05-20 16:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0008_auto_20210509_1420'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.categoryfeature', verbose_name='Характеристика')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.category', verbose_name='Категория')),
                ('feature_key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.categoryfeature', verbose_name='Ключ характеристики')),
            ],
        ),
    ]
